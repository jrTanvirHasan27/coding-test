<!-- withdrawal_transactions.blade.php -->
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6">
                    ...
                    @endif
                    <h3 class="font-semibold text-lg mb-4">Withdrawal Transactions</h3>
                    ...
                    <form action="{{ route('make.withdrawal') }}" method="POST">
                        ...
                        <button type="submit"
                            class="bg-blue-500 hover:bg-blue-700 text-black font-bold py-2 px-4 rounded border border-gray-500">Withdraw</button>
                    </form>
                </div>
            </div>
        </div>
